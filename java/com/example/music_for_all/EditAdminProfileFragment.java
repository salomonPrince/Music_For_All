...
public class EditAdminProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_edit_admin_profile, container, false);
        ...
        // Populates EditText fields with user current information
        populateUserInfo();
    ...
    // Methods to populate EditText fields with user current information
